...
const propertyData = {
  1: {
    ...
    features: ["Waterfront", "Smart Home", "Private Beach", "Pool", "Gym", "Cinema", "Wine Cellar", "Elevator"],
    description:
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
        ...
        <div className="pt-32 text-center">
          ...
          <Link href="/properties" className="text-emerald-600 hover:text-emerald-700">
            ← Back to Properties
          </Link>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mb-8">
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6">
              <div>
                <h1 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-4">{property.title}</h1>
              ...
              <div className="text-right">
                <div className="text-4xl font-bold text-emerald-600 mb-2">{property.price}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white/80 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/20">
                <h2 className="text-3xl font-serif font-bold text-gray-900 mb-6">About This Property</h2>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {property.features.map((feature) => (
                    <div key={feature} className="flex items-center bg-emerald-50 px-3 py-2 rounded-lg">
              ...
              {/* Amenities */}
              <div className="bg-white/80 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/20">
                <h2 className="text-3xl font-serif font-bold text-gray-900 mb-6">Amenities</h2>
              ...
              {/* Nearby Places */}
              <div className="bg-white/80 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/20">
                <h2 className="text-3xl font-serif font-bold text-gray-900 mb-6">Nearby Places</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 text-white rounded-2xl p-6 shadow-xl">
                <h3 className="text-xl font-semibold mb-4">Investment Projection</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span>Current Value:</span>
                    <span className="font-bold">₦{(property.roiProjection.currentValue / 1000000).toFixed(0)}M</span>
                  </div>
                  <div className="flex justify-between">
                    <span>18-Month Projection:</span>
                    <span className="font-bold">
                      ₦{(property.roiProjection.projected18Months / 1000000).toFixed(0)}M
                    </span>
                  </div>
                  <div className="border-t border-emerald-400 pt-3">
                    <div className="flex justify-between text-lg">
                      <span>Potential ROI:</span>
                      <span className="font-bold text-amber-300">{property.roiProjection.projectedROI}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-white/20">
                ...
                <div className="space-y-3">
                  ...
                  <a
                    href={`https://wa.me/${property.agent.phone.replace(/[^0-9]/g, "")}?text=Hi, I'm interested in ${property.title}`}
